...
<div class="flex flex-col gap-3">
  <div class="grid grid-cols-2 gap-3">
    ...
    <Card class="flex flex-col gap-1">
      <span class="text-xs font-medium uppercase tracking-wide text-text-light/60 dark:text-text-dark/60">
        Income
      </span>
  ...
  <Card class="flex items-center justify-between">
    <span class="text-sm font-medium text-text-light/70 dark:text-text-dark/70">
      Balance
    </span>
