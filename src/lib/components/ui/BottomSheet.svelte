...
{#if isOpen}
	...
	>
		<!-- Handle -->
		<div
			class="mx-auto mb-6 h-1.5 w-12 rounded-full bg-surface-dark/20 dark:bg-surface-light/20"
		></div>

		{#if title}
			<h2 class="mb-4 px-6 text-center text-lg font-semibold text-text-light dark:text-text-dark">
				{title}
			</h2>
		{/if}
